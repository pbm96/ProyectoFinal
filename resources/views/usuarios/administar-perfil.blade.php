            ...
            <div class="col-md-4 mb-4">
                <div class="card profile-card">
                    <div class=" mt-3 mb-4 ">
                        ...
                        <img src="{{ asset('imagenes/perfil/'.$usuario->imagen)}}" class="rounded-circle" width="250" height="250" alt="First sample avatar image">                        @else
                        <img src="{{ asset('imagenes/perfil/user-default.png')}}" class="rounded-circle" width="250" height="250" alt="First sample avatar image">                        @endif
                    </div>
                    ...
                    <div class="card-body pt-0 mt-0">
                        ...
                        <div class="row justify-content-end ">
                            ...
                            {!! Form::Open(['route'=>['borrar_perfil',$usuario->id],'method'=>'DELETE','files'=>true]) !!} {!!Form::submit('Borrar Perfil',['class'=>'btn
                            btn-outline-danger waves-effect confirm ','data-confirm' => 'Seguro que quieres borrar el Usuario?
                            NO HABRA VUELTA ATRÁS'])!!} {!! Form::close() !!}
                        </div>
            ...
            <div class="col-md-8 mb-4">
                ...
                <div class="card card-cascade cascading-admin-card user-card">
                        ...
                        <div class="row mb-5">
                            ...
                            <div class="col-sm-6 ">
                                <div class="md-form form-sm mb-2">
                                    ...
                                    <input type="password" class="form-control form-control-sm {{ $errors->has('password') ? ' invalid' : '' }}" id="confirmar_contraseña"
                    ...
                    <div class="row justify-content-end mr-5 mb-3">
                        {!!Form::submit('Modificar Perfil',['class'=>'btn btn-primary '])!!} {!! Form::close() !!}
                    </div>
                </div>
            </div>
        </div>
